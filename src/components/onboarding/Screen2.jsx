...
const Screen2 = () => {
  ...
  const handleSelected = (e) => {
    ...
    if(name === 'student' && value === 'on' ) {
      router.push("auth/signup");
      return;
    }
    toast.error("Oops! you can only use the student service for now.");
  }
  ...
  return (
    <div className="relative h-screen px-5 overflow-hidden">
      <div className="bg-[#FAFAFA] rounded p-2 w-[36px] mt-2 pointer">
        ...
        <path fillRule="evenodd" clipRule="evenodd" d="M7.76566 13.3661C7.45324 13.6785 6.94671 13.6785 6.63429 13.3661L1.83429 8.56607C1.52187 8.25366 1.52187 7.74712 1.83429 7.4347L6.63429 2.63471C6.94671 2.32229 7.45324 2.32229 7.76566 2.63471C8.07808 2.94712 8.07808 3.45366 7.76566 3.76608L4.33135 7.20039H13.6C14.0418 7.20039 14.4 7.55856 14.4 8.00039C14.4 8.44222 14.0418 8.80039 13.6 8.80039L4.33135 8.80039L7.76566 12.2347C8.07808 12.5471 8.07808 13.0537 7.76566 13.3661Z" fill="#111827"/>
        </svg>
      </div>

      <div className='m-auto z-10 pt-16 flex items-center flex-col gap-16'>
        <div className="">
          <div className='md:w-[80%] flex items-center flex-col'>    
            ...
            <h1 className='leading-10 text-lg leading-normal text-center font-bold'>Select your preffered role</h1>
            <p className="text-center text-sm mt-2">For the best experience on this platform, we need you to select your role </p>
          </div>

          <div className='md:w-[80%] mt-[3rem]'>    
            <div className='min-w-[300px] md:w-[400px] h-[110px] flex flex-row justify-between p-4 bg-[#FAFAFA] gap-[4px] rounded-xl'>
              <div className=''>     
                <h1 className='leading-10 text-base text-[#282828] font-bold'>Students</h1>
              ...
              <div className='p-2'>
                <input onChange={handleSelected} name="student" className='p-2' type="checkbox"/>
              </div>
            </div>
            <div className='min-w-[300px] mt-6 md:w-[400px] h-[110px] flex flex-row justify-between p-4 bg-[#FAFAFA] gap-[4px] rounded-xl'>
              <div className=''>     
                <h1 className='leading-10 text-base text-[#282828] font-bold'>Hostel Agents/Property Owners</h1>
                <p className="text-[#525252] text-sm md:text-[12px]">Find tenants for your properties easily</p>
              </div>
              <div className='p-2'>
                <input onChange={handleSelected} name="agent" className='p-2' type="checkbox"/>
              </div>
            </div>
          </div>
        </div>
