...
import { modalIcon, modalImage } from '@/assets';
   ...
   <div className='bg-[#FFF] absolute h-full inset-0'>
      <div className='md:w-[450px] p-6 md:p-2 h-full m-auto z-10 pt-16 flex items-center flex-col'>    
         <span className='rounded bg-[#000000] flex items-center justify-center'>
            <Image src={modalIcon} alt='confirm_modal_Logo' className=' h-20 w-20 '/>
         </span>
         ...
         <button class="bg-[#0E0E0E] text-white rounded-lg p-3 mt-[4rem] mb-[2rem] w-full font-bold"><Link href="/auth/login">Log in to continue</Link></button>
      </div>   
   </div>
  )
}
