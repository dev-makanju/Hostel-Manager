...
import { resendOtpService } from '@/service/eventService' 
  ...
  const handleSubmit =  async (e) => {
    ...
    if(!_emailFailed && !_passFailed){
      if(!isSubmiting){
        ...
        if(res.status === 400){
          const response = await resendOtpService({email: formData.email})
  ...
  return (
    <PrivateRoute>
      <div className="relative h-screen px-5" >
        ...
        <div className='md:w-[70%] h-full m-auto z-10 pt-16  gap-16'>
          <div className="md:w-[450px]">
            <div className='md:w-full flex items-center flex-col'>    
              ...
              <h1 className='leading-10 text-lg text-center font-bold'>Welcome back!</h1>
