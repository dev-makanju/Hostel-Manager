      ...
      <div className="relative h-screen px-5" >
         ...
         <div className="md:w-[450px]">
            <div className='md:w-full flex items-center flex-col'>    
               ...
               <h1 className='leading-10 text-2xl md:text-3xl mt-2 md:leading-normal text-center font-bold'>Otp Verification</h1>
               <p className="text-center mt-2">Pls enter the OTP code sent to your provided phone number +2349062****29</p>
            </div>
