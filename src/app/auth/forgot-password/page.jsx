...
const ForgotPassword = () => {
  ...
  return (
    <div className="relative h-screen px-5 " >
      {isSelectedOption ? <PhoneModal showModal={show_modal} /> : <Modal/>} 
      ...
      <div className='md:w-[70%] h-full m-auto z-10 pt-16 flex items-center flex-col gap-16'>
        <div className="md:w-[450px]">
          <div className='md:w-full flex items-center flex-col'>    
            ...
            <h1 className='leading-10 text-2xl md:text-3xl mt-2 md:leading-normal text-center font-bold'>Forgot Password?</h1>
            <p className="text-center mt-2">No worries, enter your email or phone number to reset your password</p>
          </div>
