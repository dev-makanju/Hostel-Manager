      ...
      <div className='md:w-[70%] h-full m-auto z-10 pt-16 flex items-center flex-col gap-16'>
        <div className="md:w-[450px]">
          <div className='md:w-full flex items-center flex-col'>    
            ...
            <h1 className='leading-10 text-lg mt-2 md:leading-normal text-center font-bold'>Let’s create your account</h1>
            <p className="text-center text-sm mt-2">Please enter your personal information below, this will only take a few mins</p>
          </div>
