...
const page = () => {
   ...
   return (
      <DashboardLayout>
        ...
        {
           !searchFounded ? 
           <div className='p-3 flex justify-center items-center   h-[80%]'>
           ...
           <div>
            ...
            { isFilter && 
                  <div className='fixed bg-[#00000065] z-20 bottom-0 w-full h-[100%]'>
                     <div className="bg-[#fff] rounded-t-2xl w-full h-[100%] mt-[10%]">
                           <div className='p-3 flex justify-between items-center gap-4'>
                           ...
                           <h2 className='text-[#C97B2C] p-3 underline'>show more</h2>
                           <h2 className='font-bold p-3 text-2xl'>Others</h2>
                           <div className='flex justify-between p-3'>
                              <h4>Rental listing by House Owner</h4>
                              <Switch defaultChecked onChange={onChange} /> 
                           </div>
                           <div className='flex justify-between p-3'>
                              <h4>Rental listing by Agents</h4>
                              <Switch defaultChecked onChange={onChange} /> 
                           </div>
                           <div className='p-3'>
                              <Button 
