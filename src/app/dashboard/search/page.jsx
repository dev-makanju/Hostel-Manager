      ...
      <DashboardLayout>
         <div className='mb-[6rem]'>
            ...
            <div className="flex justify-between items-center p-4 gap-2">
                  <div className="flex items-center bg-[#F5F5F5] w-full rounded-lg border-1">
                     <span className="p-2">
                        ...
                        <path 
                           d="M13.5137 14.3652L16.1567 17.0014" 
                           stroke="#747474" 
                           stroke-width="1.5" 
                  ...
                  {
                     searchFounded &&   
                     <div onClick={() => setIsFilter(true)} className='p-2 bg-[#F5F5F5] rounded-lg'>
               ...
               <div className='p-4 flex justify-center items-center h-[80%]'>
                  <div className='flex justify-center flex-col items-center'>
                     ...
                     <div className='flex justify-center flex-col items-center pt-5'>    
                           <h2 className='font-bold text-[#414141] text-xl'>Search not found</h2>
                           <p className='text-center text-[#414141] mt-2'>Sorry, we could not find any available hostel around that location.</p>
                     </div>
                  </div>
               </div> :
               <div>
                  <div className="flex gap-4 items-center p-3">
                     <h2 className='font-bold text-base'><span className="text-[#C97B2C] mr-2">48</span>Hostel Options</h2>
                  </div>
                  <div className='pl-3 flex gap-4 overflow-auto w-[100%]'>
                        {tags.map(tag => (
                           <div className='whitespace-nowrap text-xs p-2 font-bold rounded-lg bg-[#F5F5F5] text-[#9E9E9E]'>
                              {tag} <span className="text-[#fff] rounded-lg p-1 bg-[#000]">x</span>
                           </div>
                        ))}
                  </div>
