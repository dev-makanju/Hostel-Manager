...
import NearbyHostel from '@/components/common/nearbyHostels'
...
export default function Home() {
  ...
  return (
    <div className=' relative '>
          ...
          <div className=' grid grid-cols-2 gap-y-3 '>
          ...
          } */}
            {
              nearby.map(near => (
                ...
                <NearbyHostel bookmarked={bookmarked} setBookMarked={setBookMarked} id={near.id} {...near} />
              ))
            }
            ...
            </div>  <div className=' relative w-full max-w-[183px] flex-wrap shrink-0  h-[200px] '>
              <div className=' relative w-full'>
      ...
      <div className=' bg-white  z-50 rounded-b-md w-full fixed bottom-0' >
        <Navbar />
      </div>
    </div>
  )
